  ...
  return (
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-10 mt-10">
        {projects.map((item) => (
          <div
            className="lg:min-h-[35rem] h-[25rem] flex items-center justify-center sm:w-96
            w-[88vw] lg:w-[37.5rem] rounded-[35px] bg-dot-white-100/[0.2] bg-opacity-80 "
            key={item.id}
          >
            <PinContainer
            ...
            >
              ...
              h-[25vh] lg:h-[34vh] lg:w-[30.5rem] mb-10">
                <div
